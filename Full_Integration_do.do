...
#IN 111
mem load -skip 0 -filltype inc -filldata 0011011111100000 -fillradix binary -startaddress 7 -endaddress 7 /processor/Fetch_Decode_Stages/myfetch/INSTRUC_MEM/ram
#SETC
mem load -skip 0 -filltype inc -filldata 0001011100000000 -fillradix binary -startaddress 8 -endaddress 8 /processor/Fetch_Decode_Stages/myfetch/INSTRUC_MEM/ram
#HLT
mem load -skip 0 -filltype inc -filldata 0000111100000000 -fillradix binary -startaddress 9 -endaddress 9 /processor/Fetch_Decode_Stages/myfetch/INSTRUC_MEM/ram
